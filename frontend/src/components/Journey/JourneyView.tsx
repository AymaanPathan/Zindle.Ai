...
function srcCfg(s: string) {
  return SRC[s as keyof typeof SRC] ?? SRC.stripe;
}

function evtCfg(type: string) {
  return EVENT_CONFIG[type] ?? { icon: "·", color: G.g500, bg: G.g100 };
}

// ─── Rich Flow Node ─────────────────────────────────────────────────────────────
// Full card: icon + label + date + time + status + amount
// Clear visual hierarchy. Selected = dark fill.
  ...
  return (
    <>
      <Handle
        ...
        style={{
          opacity: 0, width: 10, height: 10, left: -5,
      ...
      <div
        ...
        style={{
          ...
          border: `1.5px solid ${isSelected ? G.g900 : hov ? G.g400 : G.g200}`,
          borderRadius: 12,
          cursor: "pointer",
          fontFamily: G.sans,
        ...
        <div style={{ padding: "10px 12px 12px" }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: 8, marginBottom: 8 }}>
            <div style={{
              ...
              fontSize: 13,
              color: isSelected ? G.white : ec.color,
              fontWeight: 700,
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{
                ...
                fontWeight: 600,
                lineHeight: 1.3,
                color: isSelected ? G.white : G.g900,
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  background: isSelected ? "rgba(255,255,255,0.5)" : s.dot,
                  flexShrink: 0,
                }} />
                <span style={{
                  fontSize: 10,
                  color: isSelected ? "rgba(255,255,255,0.45)" : G.g400,
                  letterSpacing: "0.02em",
                }}>
                  {s.label}
                </span>
          ...
          <div style={{
            height: 1,
            background: isSelected ? "rgba(255,255,255,0.08)" : G.g100,
            marginBottom: 8,
          }} />
          ...
          <div style={{
            ...
            <svg width="10" height="10" viewBox="0 0 10 10" fill="none" style={{ flexShrink: 0 }}>
              <rect x="0.5" y="1.5" width="9" height="8" rx="1.5"
                stroke={isSelected ? "rgba(255,255,255,0.35)" : G.g400}
            ...
            <span style={{
              fontSize: 10.5,
              color: isSelected ? "rgba(255,255,255,0.5)" : G.g500,
            ...
            <span style={{
              fontSize: 10,
              color: isSelected ? "rgba(255,255,255,0.3)" : G.g300,
            }}>·</span>
            <span style={{
              fontSize: 10.5,
              color: isSelected ? "rgba(255,255,255,0.4)" : G.g400,
            }}>
      ...
      <Handle
        ...
        style={{
          opacity: 0, width: 10, height: 10, right: -5,
          background: "transparent", border: "none",
        }}
      />
    </>
      ...
      edges.push({
        ...
        ...(gap
          ? {
              label: gap,
              labelStyle: {
                fontSize: 9, fill: G.g400,
                fontFamily: G.sans, fontWeight: 500,
              },
...
function EventPanel({
  ...
  const related = patterns.filter((p) =>
    (p.relatedEventIds ?? []).includes(event.id),
  );
  const statusColor = STATUS_COLOR[event.status] ?? G.g500;
  ...
  return (
    <div style={{
      ...
      height: "100%", fontFamily: G.sans,
      background: G.white,
    }}>
      {/* Panel header */}
      <div style={{
        padding: "16px 16px 12px",
        borderBottom: `1px solid ${G.g100}`,
        flexShrink: 0,
      }}>
        {/* Close + source */}
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <span style={{ fontSize: 11, color: G.g400, fontWeight: 500 }}>
              {s.label}
            </span>
          </div>
          <button
            ...
            style={{
              width: 28, height: 28,
              border: `1px solid ${G.g200}`, borderRadius: 7,
              background: G.white, color: G.g400,
              cursor: "pointer", fontSize: 16,
              display: "flex", alignItems: "center", justifyContent: "center",
              fontFamily: G.sans, transition: "all 0.1s",
            }}
            onMouseEnter={e => {
              e.currentTarget.style.background = G.g50;
              e.currentTarget.style.color = G.g700;
            }}
            onMouseLeave={e => {
              e.currentTarget.style.background = G.white;
              e.currentTarget.style.color = G.g400;
            }}
          >
            ×
          </button>
        ...
        <div style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{
              fontSize: 14, fontWeight: 600, color: G.g900,
              letterSpacing: "-0.02em", lineHeight: 1.35, marginBottom: 4,
            }}>
              {event.label}
            </div>
            <span style={{
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "16px" }}>
        ...
        <div style={{
          ...
          <div style={{
            fontSize: 10, fontWeight: 600, color: G.g400,
          ...
          <div style={{
            fontSize: 15, fontWeight: 600, color: G.g900,
            letterSpacing: "-0.02em",
          }}>
            {f.dateShort(event.timestamp)}
          </div>
        ...
        {amt != null && amt > 0 && (
          <div style={{
            padding: "12px 14px",
            background: G.g50, borderRadius: 10,
            border: `1px solid ${G.g100}`, marginBottom: 14,
          }}>
            <div style={{
              fontSize: 10, fontWeight: 600, color: G.g400,
              textTransform: "uppercase" as const,
            ...
            <div style={{
              fontSize: 22, fontWeight: 700, color: G.g900,
        ...
        {event.metadata && Object.keys(event.metadata).length > 0 && (
          <div style={{ marginBottom: 14 }}>
            ...
            <div style={{
              border: `1px solid ${G.g200}`, borderRadius: 10, overflow: "hidden",
            }}>
              {Object.entries(event.metadata).map(([k, v], i, arr) => (
                <div key={k} style={{
                  ...
                  alignItems: "center",
                  padding: "8px 12px",
                  borderBottom: i < arr.length - 1 ? `1px solid ${G.g100}` : "none",
                  background: i % 2 === 0 ? G.white : G.g50,
                }}>
                  ...
                  <span style={{
                    ...
                    whiteSpace: "nowrap" as const,
                    fontFamily:
                      typeof v === "string" && v.startsWith("in_")
                        ? "monospace"
                        : G.sans,
                  }}>
                ...
                return (
                  <div key={p.code} style={{
                    ...
                    <div style={{
                      ...
                      <span style={{
                        fontSize: 12, fontWeight: 600, color: G.g900,
                        flex: 1,
                      }}>
                        {p.label}
                      </span>
                    ...
                    <p style={{
                      fontSize: 11.5, color: G.g500, margin: 0, lineHeight: 1.6,
                    }}>
                      {p.description}
                    </p>
                  </div>
        ...
        <div>
          ...
          <div style={{
            fontSize: 10, color: G.g400,
            wordBreak: "break-all" as const,
            lineHeight: 1.6,
            fontFamily: "monospace",
            background: G.g50, padding: "8px 12px",
            borderRadius: 8, border: `1px solid ${G.g100}`,
          }}>
            {event.id}
          </div>
        </div>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <span style={{
            fontSize: 13, fontWeight: 600, color: G.g900, letterSpacing: "-0.01em",
          }}>
            Patterns
          </span>
          {data.patterns?.length > 0 && (
            <span style={{
              ...
              background: G.g100, border: `1px solid ${G.g200}`, color: G.g500,
            }}>
        ...
        <button
          ...
          style={{
            width: 26, height: 26,
            border: `1px solid ${G.g200}`, borderRadius: 6,
            background: G.white, color: G.g500,
            ...
            {data.patterns.map((p: any, i: number) => {
              ...
              return (
                <div key={p.code} style={{
                  ...
                  background: G.g50, border: `1px solid ${G.g200}`,
                  ...
                  <div style={{
                    ...
                    <span style={{
                      fontSize: 12.5, fontWeight: 600, color: G.g900,
                  ...
                  <p style={{
                    fontSize: 12, color: G.g500, margin: 0, lineHeight: 1.65,
                  }}>
                    {p.description}
                  </p>
                </div>
...
function Timeline({
  ...
  onEventClick: (e: any | null) => void;
}) {
  const sorted = useMemo(
    () => [...events].sort((a, b) => tsv(a.timestamp) - tsv(b.timestamp)),
    [events],
  );
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", fontFamily: G.sans }}>
      {groups.map(([date, evs]) => (
        <div key={date}>
          <div style={{
            ...
            fontSize: 11, fontWeight: 600, color: G.g500,
          ...
          {evs.map((ev) => {
            ...
            return (
              <div
                ...
                onMouseEnter={e => {
                  if (!isSel) e.currentTarget.style.background = G.g50;
                }}
                onMouseLeave={e => {
                  if (!isSel) e.currentTarget.style.background = G.white;
                }}
              >
                <div style={{
                ...
                <div style={{ minWidth: 0 }}>
                  <div style={{
                    fontSize: 13, fontWeight: 500, color: G.g900,
                ...
                <div style={{
                  fontSize: 11, color: G.g400, flexShrink: 0,
    ...
    <div style={{
      ...
      <button
        ...
        style={{
          ...
          cursor: "pointer", fontSize: 13, fontWeight: 400, color: G.g500,
          fontFamily: G.sans, padding: 0, transition: "color 0.12s", flexShrink: 0,
          letterSpacing: "-0.01em",
        }}
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        <div style={{
          width: 30, height: 30, borderRadius: 8,
          background: G.g100, border: `1px solid ${G.g200}`,
          display: "flex", alignItems: "center", justifyContent: "center",
          fontSize: 12, fontWeight: 600, color: G.g700,
        }}>
          {email[0]?.toUpperCase()}
        ...
        <div>
          <div style={{
            fontSize: 13.5, fontWeight: 600, color: G.g900,
      ...
      {data && (
        <span style={{
          ...
          <span style={{
            width: 5, height: 5, borderRadius: "50%", background: risk.color,
          }} />
          {risk.label}
          {riskScore != null && (
            <span style={{ opacity: 0.6, fontSize: 10.5 }}>· {riskScore}</span>
          )}
        </span>
      )}
...
function Toolbar({
  ...
  eventsCount, loading, onRefresh,
  patternCount, filterSource, onFilterSource,
}: {
  ...
  patternCount: number; filterSource: FilterSource;
  onFilterSource: (s: FilterSource) => void;
}) {
  return (
    <div style={{
      background: G.white,
      ...
      {/* View toggle */}
      <div style={{
        display: "flex", background: G.g100, borderRadius: 9,
          ...
          {(["all", "stripe", "resend", "hubspot"] as const).map((s) => {
            ...
            return (
              <button key={s} onClick={() => onFilterSource(s)} style={{
                ...
                border: `1px solid ${isActive ? G.g700 : G.g200}`,
                ...
                {dot && (
                  <span style={{
                    width: 5, height: 5, borderRadius: "50%",
                    background: isActive ? G.white : dot, flexShrink: 0,
                  }} />
                )}
      ...
      {eventsCount > 0 && (
        <span style={{ fontSize: 11, color: G.g400 }}>{eventsCount} events</span>
      )}
      ...
      <button onClick={onInsightsToggle} style={{
        ...
        {patternCount > 0 && (
          <span style={{
            ...
            background: showInsights ? "rgba(255,255,255,0.18)" : G.g100,
      ...
      <button
        ...
        onMouseEnter={e => {
          e.currentTarget.style.background = G.g50;
          e.currentTarget.style.color = G.g900;
        }}
        onMouseLeave={e => {
          e.currentTarget.style.background = G.white;
          e.currentTarget.style.color = G.g500;
        }}
      >
        <svg
        ...
        >
          <path
            d="M1 6C1 3.24 3.24 1 6 1c1.5 0 2.85.6 3.84 1.57M11 6c0 2.76-2.24 5-5 5-1.5 0-2.85-.6-3.84-1.57"
            stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"
          />
          <path
            d="M9 2.5l.84-.57.93.57"
...
function Loading() {
  return (
    <div style={{
      ...
      <span style={{ fontSize: 12, color: G.g400, fontFamily: G.sans }}>
        Building journey…
      </span>
    </div>
  );
...
function FlowEmpty() {
  return (
    <div style={{
      ...
      <div style={{ fontSize: 13, fontWeight: 600, color: G.g700 }}>
        No events yet
      </div>
      <div style={{ fontSize: 12, color: G.g400 }}>
        Events will appear here as activity is recorded.
      </div>
    </div>
  );
}

// ─── Flow legend (lane labels outside canvas) ──────────────────────────────────
function LaneLegend() {
  return (
    <div style={{
      ...
      background:
        "linear-gradient(to right, rgba(249,250,251,0.98) 65%, transparent)",
    }}>
      {(["stripe", "resend", "hubspot"] as const).map((lane, i) => {
        ...
        return (
          <div key={lane} style={{
            ...
            paddingLeft: 10,
            borderTop: i > 0 ? `1px solid ${G.g200}` : "none",
          }}>
            <div style={{
...
export default function JourneyView({
  ...
  useEffect(() => {
    ...
    const { nodes, edges } = buildGraph(
      data.events, selectedEvent?.id ?? null, handleNodeClick,
    );
    setRfNodes(nodes);
    setRfEdges(edges);
  ...
  return (
    <>
      <style>{`
        ...
        .jv .react-flow__controls-button:hover {
          background: #f9fafb !important;
        }
        .jv .react-flow__edge-label {
          font-family: 'Geist', -apple-system, system-ui, sans-serif !important;
        }
        .jv .react-flow__minimap {
          border-radius: 10px !important;
          border: 1px solid #e5e7eb !important;
          overflow: hidden;
        }
      ...
      <div style={{
        ...
        background: G.g50, fontFamily: G.sans,
        overflow: "hidden",
      }}>
        ...
        <div style={{
          ...
          {!loading && error && (
            <div style={{
              ...
              <div style={{ fontSize: 13, fontWeight: 600, color: G.g900 }}>
                {error}
              </div>
              <div style={{ fontSize: 12, color: G.g400 }}>
            ...
            <div style={{ position: "absolute", inset: 0, display: "flex" }}>
              ...
              <div
                ...
                style={{
                  flex: 1,
                  position: "relative",
                  // Shrink when panel is open
                  marginRight: selectedEvent ? 320 : 0,
              ...
              >
                ...
                <div style={{
                  ...
                  {(["stripe", "resend", "hubspot"] as const).map((s) => (
                    <div key={s} style={{
                      ...
                      <div style={{
                        ...
                        background: SRC[s].dot,
                      }} />
                      <span style={{
                        fontSize: 10.5, color: G.g600, fontFamily: G.sans,
                        fontWeight: 500,
                      }}>
                        {SRC[s].label}
                      </span>
                  ...
                  <div style={{
                    width: 1, height: 12, background: G.g200,
                    alignSelf: "center",
                  }} />
                  <span style={{
                    fontSize: 10.5, color: G.g400, fontFamily: G.sans,
                  }}>
